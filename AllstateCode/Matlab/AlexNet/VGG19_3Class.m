...
whImagesTrain = imageDatastore('C:\TrainingSetBal_resize_224x224',...
    'IncludeSubfolders',true,...
    'LabelSource','foldernames');
% whImagesTrain.ReadFcn = @readAndResizeVGG;


whImagesTest = imageDatastore('C:\TrainingSetBal_resize_224x224',...
    'IncludeSubfolders',true,...
    'LabelSource','foldernames');
% whImagesTest.ReadFcn = @readAndResizeVGG;
